...
import 'package:story_line/core/utils/format_date.dart';
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('${formatDateBydMMMYYYY(blog.updatedAt)} . ${calculateReadingTime(blog.content)} min', style: const TextStyle(fontWeight: FontWeight.w500, color:  AppPallete.greyColor, fontSize: 16),),
                const SizedBox(height: 20,),
                ClipRRect(
